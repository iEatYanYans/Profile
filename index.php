...
<html lang="en">
  <head>
    ...
    <title>Yan Chen Dynamic Web Applications</title>
  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Yan Chen <span class="text-muted">: A Dynamic Web App Student</span></h2>
          <p class="lead"> Hey everyone! My name is Yan (pronounced Y-AN) and I'm currently enrolled in CSCI E-15, welcome to my homepage!</p>
        </div>
        <div class="col-md-5">
